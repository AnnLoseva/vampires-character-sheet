...
export const dictionary: Record<string, string> = {
  ...
  'Вот что я знаю об этом:': 'Here is what I know about it:',
  'В книгах об этом:': 'From the books:',
  ...
  'По умолчанию': 'Default',
  'говорит': 'speaking',
  'слабое соединение': 'weak connection',
  'соединение нестабильно': 'unstable connection',
  'Переподключение голоса...': 'Reconnecting voice...',
  'Не удалось восстановить голосовое соединение': 'Could not restore voice connection',
  'Голос выключен': 'Voice off',
  'Голос онлайн': 'Voice online',
  'Кто-то отключился от голоса': 'Someone left voice',
  'Голос не смог соединиться': 'Voice failed to connect',
